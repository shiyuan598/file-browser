            ...
            <form class="card" @submit.prevent="save">
                ...
                <div class="card-content">
                    ...
                    <div>
                        ...
                        <input class="input input--block" type="text" v-model="settings.userHomeBasePath" />
                    </div>
                    ...
                    <i18n path="settings.brandingHelp" tag="p" class="small">
                        <a class="link" target="_blank" href="https://filebrowser.org/configuration/custom-branding">
                    ...
                    <p>
                        <input type="checkbox" v-model="settings.branding.disableUsedPercentage" id="branding-links" />
                    ...
                    <div class="tusConditionalSettings">
                        <p>
                            <label for="tus-chunkSize">{{ $t("settings.tusUploadsChunkSize") }}</label>
                            <input
                                class="input input--block"
                                type="text"
                        ...
                        <p>
                            <label for="tus-retryCount">{{ $t("settings.tusUploadsRetryCount") }}</label>
                            <input
                                class="input input--block"
                                type="number"
            ...
            <form v-if="isExecEnabled" class="card" @submit.prevent="save">
                ...
                <div class="card-content">
                    <i18n path="settings.commandRunnerHelp" tag="p" class="small">
                        <code>FILE</code>
                        <code>SCOPE</code>
                        <a class="link" target="_blank" href="https://filebrowser.org/configuration/command-runner">
                            {{ $t("settings.documentation") }}
                        </a>
                    </i18n>
                    ...
                    <div v-for="command in settings.commands" :key="command.name" class="collapsible">
                        ...
                        <div class="collapse">
                            <textarea
                                ...
                                v-model.trim="command.value"></textarea>
                        </div>
                    </div>
                </div>

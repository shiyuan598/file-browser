...
export default {
    ...
    props: ["name", "isDir", "url", "type", "size", "modified", "index", "readOnly", "path"],
    computed: {
    ...
    methods: {
        ...
        drop: async function (event) {
            ...
            let action = (overwrite, rename) => {
                api.move(items, overwrite, rename)
                    .then(() => {
        ...
        click: function (event) {
            ...
            if (!this.singleClick && !event.ctrlKey && !event.metaKey && !this.$store.state.multiple)
                this.resetSelected();
            this.addSelected(this.index);
        },
        open: function () {
